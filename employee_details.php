...
<table id="example" class="display">
        ...
        <tbody>
            ...
            {
            ?>
            <tr class="data" data-string="<?php echo $list['emp_id']; echo $list['name']; echo $list['emptype']; echo $lsit['edudetails']; echo $list['salary']; echo $list['email']; echo $list['phno'];?>">
                <td><?php echo $i; ?></td>
                <td><?php echo $list['emp_id'] ?></td>
                <td><?php echo $list['name'] ?></td>
                <td><?php echo $list['emptype'] ?></td>
                <td><?php echo $list['edudetails'] ?></td>
                ...
                echo "<span class='btn btn-warning'><a href='edit-employee.php?emp_id=".$list['emp_id']."' style='color:white'>Edit</a></span>&nbsp;";
                
                 echo "<span class='btn btn-primary'><a href='view-employee.php?emp_id=".$list['emp_id']."' style='color:white'>View</a></span>&nbsp;";
                
               
                
                echo "<span class='btn btn-danger'><a href='?type=delete&emp_id=".$list['emp_id']."' style='color:white' onclick=\"javascript:return confirm('Are you sure you want to delete?');\">Delete</a></span>&nbsp;";
